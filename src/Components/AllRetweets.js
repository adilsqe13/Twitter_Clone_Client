...
export default function AllRetweets(props) {
    ...
    return (
        <>
            {tweet.RetweetBy.length === 0 ? <h6 className='dfjcac text-secondary'>No Retweets</h6> : retweets.map((item, index) => {
                return (
                    <div key={index} className="container mt-2 rounded-3 border-secondary box-shadow-light-0 retweets-bg-clr">
                        ...
                        <div className=" bg-transparent text-black bold margin-auto mt-1" >
                            <div className="row">
                        ...
                        <div className="row mt-4 pb-2">
                            ...
                            <div className='col-4 dfjcac'>
                                <button className='bg-transparent border-0 text-dark' title='Retweet'> <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            {/* Repost */}
                            <div className='col-4 dfjcac'>
                                <a href='/home' onClick={() => { retweetRepost(tweet._id, item._id) }} className='bg-transparent border-0 text-dark text-decoration-none' title='Repost'> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            {/* Like a post */}
                            <div className='col-4 dfjcac'>
                                <button className='bg-transparent border-0 text-dark' title='Like'> <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" viewBox="0 0 16 16">

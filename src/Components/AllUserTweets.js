...
export default function AllUserTweets() {
    ...
    return (
        <>
           { userTweets.length === 0 ? <div className='text-secondary dfjcac mt-4 pb-296'>No tweets</div> : userTweets.map((item, index) => {
                return (
                    <div key={index} className="mt-4 px-0 bottom-thin-border py-2">
                        ...
                        <div className="row px-2">
                            ...
                            <div className="col-10 pl-min-575 pl-max-575">
                                ...
                                <div className="row px-3">
                                    ...
                                    <div className='col-4 dfjcac p-0'>
                                        <div className=" bold fs-5  mwfkro ">
                                            <a href='/home' onClick={() => { handleRepost(item._id) }} className=' bg-transparent  text-secondary text-decoration-none' title='Repost'> <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" viewBox="0 0 16 16">
